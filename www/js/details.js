...
//load session variable
  ...
  $.ajax({url:'http://bgi.site40.net/bgi/fetch_topic_response',data:{id:advtId},
  ...
  $('body').on('click','#submit-comment',function(e){
    //retrive ad id
      ...
      $.ajax({type:'POST',url:'http://bgi.site40.net/bgi/respond_topic',data:{comments:comment,tid:adId,uid:id}});
      e.preventDefault();
